...
baseline_year   <- 2016
inventory_years <- c(2016, 2022, 2025)  # add new inventory year here each cycle
onedrive_folder <- "2026_GHG_update"    # update this each year to match the OneDrive folder name
